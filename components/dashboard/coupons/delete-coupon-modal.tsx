      ...
      <div className='relative w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200'>
        ...
        <div className='flex items-center justify-between px-5 pt-5 pb-3'>
          <div className='flex items-center gap-3'>
            ...
            <h2 className='text-lg font-semibold text-[#171717]'>Delete Coupon</h2>
          </div>
          <button
            type='button'
            onClick={onClose}
        ...
        <div className='px-5 py-3'>
          <p className='text-sm text-gray-600 leading-relaxed'>
            ...
            <span className='font-semibold text-gray-900'>{couponCode}</span>? This action cannot be
            undone and will permanently remove this code.
          </p>
        </div>
        ...
        <div className='px-5 py-5 mt-2 bg-gray-50 flex items-center justify-end gap-3 border-t border-gray-100'>
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isDeleting}
            className='h-10 px-5 rounded-lg text-sm font-medium bg-red-600 text-white hover:bg-red-700 transition-colors shadow-sm disabled:opacity-70 flex items-center justify-center min-w-30'
          >
