...
import { useDeleteShippingRule } from "@/hooks/useShipping";
...
export default function DeleteRuleModal({ rule, onClose }: DeleteRuleModalProps) {
      ...
      <div className='bg-white rounded-xl w-full max-w-md overflow-hidden'>
        <div className='flex items-center justify-between p-6 border-b border-gray-100'>
          <div className="flex items-center gap-3">
            ...
            <h2 className='text-xl font-semibold text-gray-800'>Delete Rule</h2>
          </div>
        ...
        <div className="p-6">
          <p className="text-gray-600 text-sm">
            Are you sure you want to delete the rule <span className="font-semibold">&quot;{rule.name}&quot;</span>? This action cannot be undone.
          </p>
        </div>
