...
const crmNavItems: CrmNavItem[] = [
  ...
  { id: "push-subscription", label: "Push for subscription modal", icon: Bell },
  { id: "feedback", label: "Feedback modal", icon: MessageSquareText },
  { id: "cancelation", label: "Cancelation modal", icon: X },
  { id: "faq", label: "FAQ", icon: CircleHelp },
  { id: "subscription", label: "Subscription", icon: Users },
  { id: "benefits", label: "Benifits", icon: Sparkles },
...
export default function CrmNavbar({
  ...
  const routedActiveId =
    pathname === "/dashboard/crm/product"
      ? "product"
